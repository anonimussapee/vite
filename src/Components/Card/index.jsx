  ...
  return (
    <div className='bg-gray-200 cursor-pointer xs:w-72 ss:w-80 sm:w-64 md:w-60 h-auto pb-2 rounded-lg overflow-hidden' onClick={()=>{
      ...
      <figure className='relative w-full mb-2 h-4/5'>
        ...
        <PlusIcon color='white' className='bg-gray-700 m-2 w-10 h-10 border-white border-double border-2 active:bg-gray-500  absolute top-0 right-0 rounded-full ' onClick={(e) =>{ cartStatus.save(cartStatus.data + 1);
        e.stopPropagation()
        }
        }/>
      </figure>
